 ...
 *   https://datatables.net/download/#bs4/dt-1.10.16/af-2.2.2/b-1.5.1/cr-1.4.1/r-2.2.1/sc-1.4.4
 *
 * Included libraries:
 *   DataTables 1.10.16, AutoFill 2.2.2, Buttons 1.5.1, ColReorder 1.4.1, Responsive 2.2.1, Scroller 1.4.4
 */
...
(function( $, window, document, undefined ) {
    ...
    function _fnFeatureHtmlFilter ( settings )
    {
        ...
        var input = '<input type="search" id="searchid" class="'+classes.sFilterInput+'"/>';
    ...
    DataTable.defaults = {
        ...
        "oLanguage": {
             ...
             */
            "sSearchPlaceholder":  "الاسم/الشعبه/النتيجة/رقم الجلوس",
    ...
    DataTable.ext = _ext = {
         ...
         *  @type string
         */
        build:"bs4/dt-1.10.16/af-2.2.2/b-1.5.1/cr-1.4.1/r-2.2.1/sc-1.4.4",
...
(function( factory ){
    ...
    $.extend( true, DataTable.defaults, {
        dom:
        "<'row'<'col-sm-12 col-md-2'l><'col-sm-12 col-md-10'f>>" +
        "<'row'<'col-sm-12'tr>>" +
    ...
    $.extend( DataTable.ext.classes, {
        ...
        sFilterInput:  "form-control form-control-mm",
        sLengthSelect: "form-control form-control-mm",
